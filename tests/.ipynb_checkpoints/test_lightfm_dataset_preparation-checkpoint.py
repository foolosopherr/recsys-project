...
def test_create_items_feature():
    ...
    expected_result = pd.Series(["Action,Author 1,2020", "Comedy,Author 2,2021", "Drama,Author 3,2022"])
...
def test_create_users_feature():
    ...
    expected_result = pd.Series(["18-35,Мужской", "age_unknown,Женский", "65+,sex_unknown"])
...
def test_custom_tokenizer():
    ...
    expected_result = ["This", "is", "a", "sample", "text", "It", "includes", "special", "characters", "like", "and", "white", "spaces"]
